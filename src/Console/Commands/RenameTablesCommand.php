...
namespace Admsys\FilamentBlog\Console\Commands;
...
class RenameTablesCommand extends Command
{
    ...
    public function handle()
    {
        Artisan::call('migrate', [
            '--path' => 'vendor/admsys/filament-blog/database/migrations/2024_05_11_152936_create_add_prefix_on_all_blog_tables.php',
            '--force' => true,
        ]);
