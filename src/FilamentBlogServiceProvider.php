...
use Admsys\FilamentBlog\Components\Card;
use Admsys\FilamentBlog\Components\Comment;
use Admsys\FilamentBlog\Components\FeatureCard;
use Admsys\FilamentBlog\Components\Header;
use Admsys\FilamentBlog\Components\HeaderCategory;
use Admsys\FilamentBlog\Components\Layout;
use Admsys\FilamentBlog\Components\RecentPost;
use Admsys\FilamentBlog\Console\Commands\RenameTablesCommand;
...
class FilamentBlogServiceProvider extends PackageServiceProvider
{
    ...
    public function register()
    {
        Route::bind('post', function ($value) {
            return \Admsys\FilamentBlog\Models\Post::where('slug', $value)->published()->firstOrFail();
        });
